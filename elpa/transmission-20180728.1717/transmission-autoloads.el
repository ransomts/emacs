...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "transmission" '("transmission-" "ratio>?" "percent-done>?" "size" "eta>?" "upload>?" "define-transmission-predicate" "download>?")))
