...
**** org-ref
     ...
     #+BEGIN_SRC emacs-lisp
       (use-package org-ref :ensure t :after (helm helm-config))
	  ...
	  (add-hook 'exwm-randr-screen-change-hook
		    (lambda ()
		      (start-process-shell-command
		       ...
		       (concat "xrandr "
			       "--output HDMI-A-0 --mode 1920x1080 --pos 0x240 --rotate left "
			       "--output DVI-D-0 --mode 1920x1080 --pos 4920x240 --rotate left "
			       "--output DisplayPort-0 --primary --mode 1920x1080 --pos 3000x1080 --rotate normal "
			       "--output DisplayPort-1 --mode 1920x1080 --pos 1080x0 --rotate normal "
			       "--output DisplayPort-2 --off "
			       "--output DisplayPort-3 --mode 1920x1080 --pos 3000x0 --rotate normal "
			       "--output  DisplayPort-4 --mode 1920x1080 --pos 1080x1080 --rotate normal")
		       ))))
)
